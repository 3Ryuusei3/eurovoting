  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        // Disable auto focus on dialog content
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-xl leading-none font-semibold font-swiss italic", className)}
      {...props}
    />
  )
}
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn("text-muted-foreground text-sm text-left font-light", className)}
      {...props}
    />
  )
}
